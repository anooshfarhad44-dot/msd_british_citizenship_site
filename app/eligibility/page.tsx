    ...
    <div className="min-h-screen">
        ...
        <div className="w-full max-w-[1120px] mx-auto px-4 text-center">
          ...
          <div className="flex flex-col sm:flex-row items-center justify-center gap-4">
            <Link
              ...
              className="inline-flex items-center gap-2.5 min-h-[54px] px-8 py-3 rounded-full font-black text-[#7a003c] bg-[#f4c400] shadow-[0_10px_30px_rgba(244,196,0,0.35)] hover:-translate-y-1 hover:shadow-[0_16px_40px_rgba(244,196,0,0.45)] transition-all duration-300 text-base relative overflow-hidden group"
            >
              {/* shimmer */}
      ...
      <section className="py-20 bg-white">
        <div className="w-full max-w-[1120px] mx-auto px-4">
          <h2 className="text-3xl md:text-4xl font-bold text-[#7a003c] text-center mb-4">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6 mb-16">
            {eligibilityRoutes.map((route, i) => (
              <div key={i} className="flex gap-4 p-6 bg-white border-[1.5px] border-[#d0dce8] rounded-2xl hover:border-[#7a003c] hover:-translate-y-1 hover:shadow-[0_12px_32px_rgba(12,35,64,0.08)] transition-all duration-300">
                <div className="w-12 h-12 bg-[#f4c400] rounded-xl flex items-center justify-center text-2xl shrink-0">
                  {route.icon}
                </div>
                <div>
                  <h3 className="font-black text-[#7a003c] text-base mb-1">{route.title}</h3>
          ...
          <div className="bg-[#f5f8fd] rounded-3xl p-10 border border-[#d0dce8] mb-14">
            <h3 className="text-2xl font-bold text-[#7a003c] mb-6 text-center">
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-5">
              {[
                ...
                <div key={req.title} className="bg-white rounded-2xl p-6 border border-[#d0dce8] text-center">
                  ...
                  <h4 className="font-black text-[#7a003c] text-base mb-2">{req.title}</h4>
          ...
          <h2 className="text-3xl font-bold text-[#7a003c] mb-8 text-center">Detailed Route Requirements</h2>
            ...
            {citizenshipRoutes.map((route, i) => (
              <div key={i} className="bg-white rounded-2xl p-8 border border-[#d0dce8] shadow-[0_4px_20px_rgba(12,35,64,0.05)]">
                <div className="flex items-start gap-6">
                  <div className="shrink-0 w-12 h-12 bg-gradient-to-br from-[#7a003c] to-[#7a003c] rounded-xl flex items-center justify-center text-white font-black text-lg">
                    {i + 1}
                  </div>
                  <div className="flex-1">
                    <div className="text-xs font-black uppercase tracking-widest text-[#7a003c] mb-1">{route.subtitle}</div>
                    <h3 className="text-xl font-bold text-[#7a003c] mb-3">{route.title}</h3>
                    <p className="text-[#4a6480] leading-relaxed mb-5">{route.description}</p>
                    <div className="bg-[#f5f8fd] rounded-xl p-5">
                      <div className="text-xs font-black uppercase tracking-widest text-[#7a003c] mb-3">Requirements</div>
          ...
          <div className="text-center mt-14">
            ...
            <div className="flex flex-col sm:flex-row gap-4 justify-center">
              <Link
                href="/eligibility/check"
                className="inline-flex items-center gap-2 justify-center min-h-[52px] px-10 py-3 rounded-full font-extrabold bg-[#f4c400] text-[#7a003c] shadow-[0_14px_30px_rgba(244,196,0,0.25)] hover:-translate-y-0.5 transition-all duration-200"
              >
              ...
              <Link
                href="/contact"
                className="inline-flex items-center justify-center min-h-[52px] px-8 py-3 rounded-full font-extrabold border border-[#7a003c]/30 text-[#7a003c] hover:bg-[#f4f7fb] transition-all duration-200"
              >
