    ...
    <div className="min-h-screen">
      ...
      <section className="py-20 bg-white">
        <div className="w-full max-w-[1120px] mx-auto px-4">
          <h2 className="text-3xl md:text-4xl font-bold text-[#0c2340] text-center mb-14">
          ...
          <div className="grid grid-cols-1 gap-8 mb-16">
            {processSteps.map((step, index) => (
              <div key={index} className="flex gap-6 items-start">
                <div className="shrink-0 w-14 h-14 bg-gradient-to-br from-[#f4c400] to-[#d4ab00] rounded-2xl flex items-center justify-center font-black text-[#0c2340] text-xl shadow-[0_6px_16px_rgba(244,196,0,0.3)]">
                  {index + 1}
                </div>
                <div className="flex-1 pt-2">
                  <h3 className="text-xl font-extrabold text-[#0c2340] mb-2">{step.title}</h3>
          ...
          <div className="bg-[#f5f8fd] rounded-3xl p-10 border border-[#d0dce8] mb-14">
            <h3 className="text-2xl font-bold text-[#0c2340] mb-8 text-center">What to Expect</h3>
            <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
              {[
                ...
                <div key={item.title} className="bg-white rounded-2xl p-6 border border-[#d0dce8] text-center">
                  ...
                  <h4 className="font-black text-[#0c2340] mb-2">{item.title}</h4>
