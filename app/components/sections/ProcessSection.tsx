      ...
      <div className="w-full max-w-[1120px] mx-auto px-4">
        <Reveal>
          <div className="text-center mb-14">
            <p className="text-[#7a003c] font-extrabold text-sm tracking-widest uppercase mb-3">How It Works</p>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
            {processSteps.map((step, index) => (
              ...
              >
                <div className="w-12 h-12 bg-gradient-to-br from-[#f4c400] to-[#d4ab00] rounded-xl flex items-center justify-center font-black text-[#7a003c] text-lg mb-4 shadow-[0_6px_16px_rgba(244,196,0,0.3)]">
                  {index + 1}
                </div>
                ...
                <h3 className="text-lg font-extrabold text-[#7a003c] mb-2">{step.title}</h3>
          ...
          <div className="text-center mt-12">
            <Link
              href="/contact"
              className="inline-flex items-center justify-center min-h-[52px] px-8 py-3 rounded-full font-extrabold bg-[#f4c400] text-[#7a003c] shadow-[0_14px_30px_rgba(244,196,0,0.25)] hover:-translate-y-0.5 transition-all duration-200"
            >
