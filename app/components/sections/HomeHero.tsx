    ...
    <section className="relative overflow-hidden min-h-[680px] lg:min-h-[760px] flex items-center bg-[#4a0025]">
      ...
      <div className="absolute inset-0 z-0">
        <Image
          ...
          fill
          className="object-cover object-[50%_10%] lg:object-[75%_10%]"
          priority
        />
        {/* Bottom section divider blend only */}
        <div className="absolute left-0 right-0 bottom-0 h-16 bg-gradient-to-b from-transparent to-white pointer-events-none z-20" />
      </div>
