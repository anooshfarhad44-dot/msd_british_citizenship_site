...
function nextFrom(qid: string, value?: AnswerValue, answers?: Record<string, AnswerValue>): string {
  switch (qid) {
    ...
    // Q3 — good character
    case "q3":
      if (value === "No — I have concerns about this") return "ineligible_character";
      return "q4";

    // Q4 — criminal record / immigration breaches
    case "q4":
      if (value === "Yes — one or more apply") return "ineligible_criminal";
      return "q5";

    // Q5 — English language requirement (Bypasses everything to 'eligible' if Exempt)
    case "q5":
      if (value === "Yes — I am exempt (age, disability, nationality, or qualification)") return "eligible"; // Foran Eligible!
      if (value === "Yes — I have passed a SELT B1 test ") return "q7";
      if (value === "Yes — I passed it as part of my visa application") return "q7";
      return "q6";
    ...
    case "q7":
      if (value === "Yes — I passed it for my ILR") return "q8";
      if (value === "Yes — I will sit it before applying") return "q8";
      if (value === "No — I am exempt (under 18 or over 65)") return "eligible"; // Foran Eligible!
      if (isAnswer(value, "No")) return "ineligible_lifetest";
      return "q8";

    // Q8 — absences from UK
    case "q8":
      if (value === "No — I have exceeded the limits") return "ineligible_absences";
      return "q9";

    // Q9 — HMRC / bankruptcy / NHS debt
    case "q9":
      if (value === "Yes — one or more apply") return "ineligible_financial";
      return "q10";
