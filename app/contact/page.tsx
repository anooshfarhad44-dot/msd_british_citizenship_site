...
export default function ContactPage() {
  return (
    <div className="min-h-screen">
      ...
      <section className="py-16 bg-gradient-to-br from-[#fff5f8] to-white">
        <div className="w-full max-w-6xl mx-auto px-4">
          <Reveal>
            <div className="grid grid-cols-1 lg:grid-cols-[0.9fr_1.1fr] gap-10 items-start">
              ...
              <div>
                ...
                <div className="flex flex-col gap-4 mb-8">
                  <a
                    ...
                    className="flex items-center gap-4 p-5 bg-white rounded-2xl border border-[#d0dce8] hover:border-[#f4c400] hover:-translate-y-1 transition-all duration-200 group"
                  >
                    <div className="w-12 h-12 bg-[#f4c400] rounded-xl flex items-center justify-center shrink-0">
                      <svg
                        ...
                        strokeWidth="2.5"
                      >
                        <path d="M22 16.92v3a2 2 0 0 1-2.18 2 19.79 19.79 0 0 1-8.63-3.07 19.5 19.5 0 0 1-6-6 19.79 19.79 0 0 1-3.07-8.67A2 2 0 0 1 4.11 2h3a2 2 0 0 1 2 1.72 12.84 12.84 0 0 0 .7 2.81 2 2 0 0 1-.45 2.11L8.09 9.91a16 16 0 0 0 6 6l1.27-1.27a2 2 0 0 1 2.11-.45 12.84 12.84 0 0 0 .7 2.81 2 2 0 0 1 2 1.72H22v-3a2 2 0 0 1-2-2h-3a2 2 0 0 0-2 1.72" />
                      </svg>
                    </div>
                    <div>
                      <div className="text-xs font-black uppercase tracking-widest text-[#7a003c] mb-0.5">
                        Call Us
                      </div>
                      <div className="font-extrabold text-[#7a003c] group-hover:text-[#7a003c] transition-colors">
                        {contact.phone}
                      </div>
                    </div>
                  </a>
                  ...
                  <a
                    ...
                    className="flex items-center gap-4 p-5 bg-white rounded-2xl border border-[#d0dce8] hover:border-[#25D366] hover:-translate-y-1 transition-all duration-200 group"
                  >
                    ...
                    <div>
                      <div className="text-xs font-black uppercase tracking-widest text-[#25D366] mb-0.5">
                        WhatsApp
                      </div>
                      <div className="font-extrabold text-[#7a003c]">
                        Chat with us now
                      </div>
                    </div>
                  </a>
                ...
                <div className="flex flex-col gap-3">
                  {officeInfo.map((office) => (
                    <div
                      key={office.city}
                      className="p-5 bg-white rounded-2xl border border-[#d0dce8] hover:border-[#f4c400] transition-all duration-300"
                    >
                      <div className="font-black text-[#7a003c] text-sm mb-1">
                        {office.city}
                      </div>
                      <div className="text-xs text-[#4a6480] mb-1.5">
                        {office.address}
                      </div>
                      <a
                        href={office.href}
                        className="text-xs font-bold text-[#f4c400] hover:text-[#7a003c] transition-colors"
                      >
                        {office.phone}
                      </a>
                    </div>
              ...
              {/* Right: Form */}
              <div className="bg-white rounded-2xl p-8 shadow-[0_10px_40px_rgba(122,0,60,0.1)]">
                <CaseReviewForm />
              </div>
            </div>
          </Reveal>
